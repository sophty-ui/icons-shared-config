<p align="center"><img src="https://cdn.jsdelivr.net/gh/Sophty-UI/icons-shared-config/media/banner.svg" alt="Package logo"></p>
...
> use `node --experimental-specifier-resolution=node node_modules/.bin/icons-shared-config` while [ESM](https://nodejs.org/api/esm.html) is in `Experimental`
